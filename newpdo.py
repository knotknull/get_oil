...
# URL of the Patriot Discount Oil website
...
# Find the element containing "Today’s Oil Price"
price_element = soup.find('div', text="Today’s Oil Price")

# Extract the price information associated with this text
if price_element:
    current_price = price_element.find_next('div').text.strip()
